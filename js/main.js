...
function mainMenuSetup() {
  ...
  const menuLiHasChild = document.querySelector('.mainMenu').querySelectorAll('li.hasChild');
  const menuLi = document.querySelectorAll('.mainMenu > ul > li');
  // ---  手機版設定
  ...
  function checkUlWidth() {
    ...
    let menuLeft = document.querySelector('.container').offsetLeft;
    menuLi.forEach((v, i) => {
